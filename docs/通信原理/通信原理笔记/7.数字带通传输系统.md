...
一个2FSK信号可以看成两个不同载频的2ASK信号的叠加,即
$$
...
系统误码率
$$
P_{e}=\frac{1}{2}erfc(\frac{a}{\sqrt{2}\sigma_{z}})\overset{\sigma_{z}^{2}=2\sigma_{n}^{2}}{\operatorname*{\operatorname*{\longrightarrow}}}P_{e}=\frac{1}{2}erfc\left(\frac{a}{2\sigma_{n}}\right)\overset{r=\frac{a^{2}}{2\sigma_{n}^{2}}}{\operatorname*{\operatorname*{\longrightarrow}}}\boxed{P_{e}=\frac{1}{2}erfc\left(\sqrt{\frac{r}{2}}\right)}
$$
大信噪比时(r>>1)
$$
